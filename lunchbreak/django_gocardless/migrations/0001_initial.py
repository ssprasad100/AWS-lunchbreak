    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_name', models.CharField(blank=True, help_text='Required unless family_name and given_name are provided.', max_length=255)),
                ...
                ('swedish_identity_number', models.CharField(blank=True, max_length=255)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scheme', models.CharField(blank=True, choices=[('autogiro', 'Autogiro'), ('bacs', 'Bacs'), ('sepa_core', 'Sepa Core'), ('sepa_cor1', 'Sepa Cor1')], max_length=255)),
                ('status', models.CharField(choices=[('pending_submission', 'Pending submission'), ('submitted', 'Submitted'), ('active', 'Active'), ('failed', 'Failed'), ('cancelled', 'Cancelled'), ('expired', 'Expired')], default='pending_submission', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organisation_id', models.CharField(blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(null=True)),
                ('description', models.TextField(blank=True)),
                ('scheme', models.CharField(blank=True, choices=[('autogiro', 'Autogiro'), ('bacs', 'Bacs'), ('sepa_core', 'Sepa Core'), ('sepa_cor1', 'Sepa Cor1')], max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interval_unit', models.CharField(choices=[('weekly', 'Weekly'), ('monthly', 'Monthly'), ('yearly', 'Yearly')], max_length=255)),
                ('month', models.CharField(blank=True, choices=[('january', 'January'), ('february', 'February'), ('march', 'March'), ('april', 'April'), ('may', 'May'), ('june', 'June'), ('july', 'July'), ('august', 'August'), ('september', 'September'), ('october', 'October'), ('november', 'November'), ('december', 'December')], max_length=255)),
                ('name', models.CharField(blank=True, max_length=255)),
                ('payment_reference', models.CharField(blank=True, max_length=140)),
                ('start_date', models.DateField(null=True)),
                ('status', models.CharField(choices=[('pending_customer_approval', 'Pending customer approval'), ('customer_approval_denied', 'Customer approval denied'), ('active', 'Active'), ('finished', 'Finished'), ('cancelled', 'Cancelled')], default='pending_customer_approval', max_length=255)),
