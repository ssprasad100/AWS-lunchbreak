    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preorder_days', models.IntegerField(default=-1, help_text='Minimum dagen op voorhand bestellen voor het uur ingesteld op de winkel. (-1 is uitgeschakeld, 0 is dezelfde dag voor het bepaalde uur.)', verbose_name='dagen op voorhand bestellen')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gocardless_enabled', models.BooleanField(default=True, help_text='Online betalingen ingeschakeld, er moet een GoCardless merchant gelinkt worden voor online betalingen aanvaard kunnen worden.', verbose_name='gocardless betalingen ingeschakeld')),
                ('payconiq_enabled', models.BooleanField(default=True, help_text='Online betalingen ingeschakeld, er moet een Payconiq merchant gelinkt worden voor online betalingen aanvaard kunnen worden.', verbose_name='payconiq betalingen ingeschakeld')),
