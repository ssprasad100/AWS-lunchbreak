    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.IntegerField(choices=[(0, 'Cash'), (1, 'Online (veilig via GoCardless)'), (2, 'Online (veilig via Payconiq)')], default=0, help_text='Betalingswijze.', verbose_name='betalingswijze')),
            ],
            options={
